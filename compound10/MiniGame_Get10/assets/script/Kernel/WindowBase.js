...
cc.Class({
    ...
    //            node.on( "click", Window[funcName], Window );
                ...
                clickEventHandler2.target = Window.node;
                clickEventHandler2.component = Window.__classname__;
                Window.OnButtonSound = function()
                {
                    Audio.playButtonSound();
                }
                clickEventHandler2.handler = "OnButtonSound";

                button.clickEvents[1] = clickEventHandler2;
            }
        }
    },
    ...
    onLoad() 
    {
        ...
        if( this.Modal )
        {
            ...
            nodeModal.width = 720*2;
            nodeModal.height = 1280*2;
